    ...
    while 1:
        ...
        if z > 3:
            ...
            if ue_count >= 2 and ue_count < 4:
                run_following_EM1.move_default(10, 10, 0.08)
            elif ue_count >= 4 and ue_count < 6:
                run_following_EM1.move_default(10, 10, 0.08)
            elif ue_count >= 6 and ue_count < 8:
                run_following_EM1.move_default(10, 10, 0.5)
            else:
                run_following_EM1.move_default(10, 10, 1)
            time.sleep(2)
            ue_count += 1
...
def stuck_avoid_move(x):
    if x == 0:
        ...
        time.sleep(1)
        run_following_EM1.move_default(-10, -10, 5)
        time.sleep(1)
    elif x == 1:
        run_following_EM1.move_default(10, -10, 1)
        time.sleep(1)
        ...
        run_following_EM1.move_default(10, -10, 3)
        time.sleep(1)
        run_following_EM1.move_default(10, 10, 3)
        time.sleep(1)
