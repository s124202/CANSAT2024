    ...
    while 1:
        ...
        if z > 3:
            ...
            if ue_count >= 2 and ue_count < 4:
                run_following_EM1.move_default(40, 40, 0.08)
            elif ue_count >= 4 and ue_count < 6:
                run_following_EM1.move_default(70, 70, 0.08)
            elif ue_count >= 6 and ue_count < 8:
                run_following_EM1.move_default(100, 100, 0.5)
            else:
                run_following_EM1.move_default(12, 12, 1)
            time.sleep(2)
            ue_count += 1
...
def yoko_jug():
    ...
    while 1:
        ...
        if x < 9 or 15 < x:
            ...
            print(f'abs(acc): {x}')
            if yoko_count % 2 == 0:
                run_following_EM1.move_default(10, 0, 3)
            else:
                run_following_EM1.move_default(0, 10, 3)
            time.sleep(1)
            yoko_count += 1
...
def stuck_avoid_move(x):
    if x == 0:
        run_following_EM1.move_default(-100, -100, 2)
        time.sleep(1)
        run_following_EM1.move_default(-60, -60, 5)
        time.sleep(1)
    elif x == 1:
        run_following_EM1.move_default(40, -40, 1)
        time.sleep(1)
        run_following_EM1.move_default(80, 80, 5)
        time.sleep(1)
    elif x == 2:
        run_following_EM1.move_default(-100, 100, 2)
        time.sleep(1)
        ...
        run_following_EM1.move_default(100, -100, 3)
        time.sleep(1)
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        run_following_EM1.move_default(a, a, b)